            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">申报登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>项目预览图</label>
                                        <img id="xiangmuPhotoImg" width="100" height="100">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zhuanjiName" name="zhuanjiName" class="form-control"
                                                   v-model="ruleForm.zhuanjiName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zhuanjiIdNumber" name="zhuanjiIdNumber" class="form-control"
                                                   v-model="ruleForm.zhuanjiIdNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zhuanjiPhone" name="zhuanjiPhone" class="form-control"
                                                   v-model="ruleForm.zhuanjiPhone" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>照片</label>
                                        <img id="zhuanjiPhotoImg" width="100" height="100">
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否通过</label>
                                    <input id="tongguoValue" name="tongguoValue" class="form-control"
                                           v-model="ruleForm.tongguoValue" readonly>
                                </div>

                                <input id="zhuanjiId" name="zhuanjiId" v-model="ruleForm.zhuanjiId" readonly type="hidden">
