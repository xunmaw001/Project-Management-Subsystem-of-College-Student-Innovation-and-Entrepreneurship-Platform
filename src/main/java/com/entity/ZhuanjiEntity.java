 ...
 */
@TableName("zhuanji")
public class ZhuanjiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhuanjiEntity() {

	}

	public ZhuanjiEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zhuanji{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", zhuanjiName=" + zhuanjiName +
            ", sexTypes=" + sexTypes +
            ", zhuanjiIdNumber=" + zhuanjiIdNumber +
            ", zhuanjiPhone=" + zhuanjiPhone +
            ", zhuanjiPhoto=" + zhuanjiPhoto +
